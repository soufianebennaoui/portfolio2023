            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <span className="contact__card-data">
                  Bennaouisoufiane1@gmail.com
                </span>
                <a
                  href="mailto:Bennaouisoufiane1@gmail.com"
                  target="_blank"
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">+212-687-61-64-64</span>
                  <a
                    href="https://api.whatsapp.com/send?phone=0687616464text=Hello, more information!"
                    target="_blank"
                    className="contact__button"
                    rel="noreferrer"
                  >
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">Soufiane Bennaoui</span>
                  <a
                    href="https://www.facebook.com/messages/t/100005081953676/"
                    className="contact__button"
                    target="_blank"
                    rel="noreferrer"
                  >
